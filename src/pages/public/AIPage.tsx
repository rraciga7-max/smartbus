    ...
    <div className="py-12 lg:py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {aiModules.map((mod, idx) => (
          <div
            key={idx}
            className="p-8 rounded-[32px] bg-surface-container-lowest dark:bg-slate-900 border border-surface-container dark:border-slate-800 shadow-xl space-y-6 hover:border-indigo-500/40 transition-all flex flex-col justify-between"
          >
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2 text-xs">
                <div className="p-3.5 rounded-2xl bg-error/5 dark:bg-error/10 border border-error/10">
                  <div className="font-bold text-error uppercase text-[10px] tracking-wider mb-1">🚨 Problem</div>
                  <div className="text-on-surface-variant dark:text-slate-300">{mod.problem}</div>
                </div>

                <div className="p-3.5 rounded-2xl bg-surface-container dark:bg-slate-800/60">
                  <div className="font-bold text-primary dark:text-indigo-400 uppercase text-[10px] tracking-wider mb-1">🧠 AI Analysis</div>
                  <div className="text-on-surface-variant dark:text-slate-300">{mod.aiAnalysis}</div>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-purple-500/5 dark:bg-purple-950/20 border border-purple-500/20">
                  ...
                  <div className="text-on-surface-variant dark:text-slate-300">{mod.prediction}</div>
                </div>
      ...
      <div className="text-center pt-8">
        <NavLink
          to="/ai-assistant"
          className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-extrabold text-sm shadow-xl shadow-indigo-600/30 transition-all"
        >
