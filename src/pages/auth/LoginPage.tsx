    ...
    <div className="min-h-screen bg-background dark:bg-slate-950 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 selection:bg-primary/20">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-surface-container-lowest dark:bg-slate-900 border border-surface-container dark:border-slate-800 rounded-[32px] p-8 shadow-2xl space-y-6">
          {errorMsg && (
            <div className="p-3.5 rounded-2xl bg-error/10 border border-error/20 text-error text-xs font-semibold flex items-center gap-2 animate-in fade-in duration-200">
          ...
          <div className="space-y-3 pt-2 border-t border-surface-container dark:border-slate-800">
            <button
              ...
              className="w-full py-3 rounded-2xl bg-surface-container dark:bg-slate-800 border border-outline/20 hover:bg-surface-container-high dark:hover:bg-slate-700 text-on-surface dark:text-slate-200 text-xs font-bold transition-all flex items-center justify-center gap-2"
            >
          ...
          <div className="p-4 rounded-2xl bg-surface-container-low dark:bg-slate-800/60 border border-surface-container dark:border-slate-700/60 space-y-2.5">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-1.5">
              <button
                ...
                className="p-2 rounded-xl bg-surface-container dark:bg-slate-800 hover:bg-primary hover:text-on-primary text-[10px] font-bold transition-all text-center"
              >
                Super Admin
              </button>
              <button
